...
# --- ESTILO CUSTOMIZADO (ALTO CONTRASTE & CORES VIVAS) ---
st.markdown("""
    <style>
    ...
    /* Fontes Globais e Contraste dos Rótulos */
    ...
    /* ESTILO DAS ABAS (Destaque para não apagar) */
    ...
    button[data-baseweb="tab"] div p {
        color: #334155 !important; /* Texto escuro bem legível */
        font-weight: bold !important;
        font-size: 18px !important;
    }
    ...
    button[data-baseweb="tab"][aria-selected="true"] div p {
        color: #FFFFFF !important; /* Texto branco na aba selecionada */
    }
...
# --- CONTAINER PRINCIPAL (PAINEL BRANCO OPACO) ---
with st.container():
    # Cabeçalho com Logo
    ...
    with aba1:
        st.markdown("<h3 style='color: #002D62;'>Consultar um único nome</h3>", unsafe_allow_html=True)
